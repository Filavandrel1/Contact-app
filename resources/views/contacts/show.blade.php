@extends('layouts.main') @section('title', "Contact ". $contact['name'] . "
              ...
              <div class="col-md-12">
                ...
                <div class="form-group row mb-0">
                  <div class="col-md-9 offset-md-3">
                    ...
                    <form action="{{route('contacts.destroy', $contact['id'])}}" onsubmit=" return confirm('Are you sure?')" style="display:inline" method='post'>
                      @csrf
                      @method('delete')
